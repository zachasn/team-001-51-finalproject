...
PackageEncryptionDecorator::PackageEncryptionDecorator(Package* p,
                                                       std::string encryption)
    : PackageDecorator(p), encryptionType(encryption) {}
...
void PackageEncryptionDecorator::setEncryptionDetails(std::string encryption) {
